...
public partial class MainViewModel : BaseViewModel
{
    ...
    public MainViewModel(ILogger<MainViewModel> logger, INavigationService navigationService, IGameStateService gameStateService) : base(logger)
    {
        ...
        NavigationItems = new ObservableCollection<NavigationItem>
        {
            ...
            CreateNavItem("Mod Loader", "M4 4h16v2H4zm0 4h16v2H4zm0 4h16v2H4zm0 4h16v2H4z", typeof(BepInExInstallViewModel)),
            CreateNavItem("Mods", "M6 2h12v2H6zm0 4h12v2H6zm0 4h12v2H6zm0 4h8v2H6z", typeof(BrowseModsViewModel)),
